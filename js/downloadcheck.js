...
jQuery(document).ready(function () {
	...
	if ($('#jquerycdnjs').isChecked()) {
		cdn = cdn + "&lt;!-- jQuery 1.11.3 minified from cdn--><br>&lt;script src='https://cdn.cloudflare.com/ajax/libs/jquery/2.1.4/jquery.js'>&lt;/script><br>"
	}
	...
	if ($('#jquery1cdnjs').isChecked()) {
		cdn = cdn + "&lt;!-- jQuery 1.11.3 minified from CDNJS--><br>&lt;script src='https://cdn.cloudflare.com/ajax/libs/jquery/1.11.3/jquery.min.js'>&lt;/script><br>"
	}
	...
	if ($('#mootoolscdnjs').isChecked()) {
		cdn = cdn + '&lt!-- Mootools from cdn --><br>&lt;script src="https://cdn.cloudflare.com/ajax/libs/mootools/1.5.2/mootools-core-compat.min.js">&lt;/script><br>'
	...
	if ($('#angularjscdnjs').isChecked()) {
		cdn = cdn + '&lt;!-- AngularJS from CDNJS --><br>&lt;script src="https://cdn.cloudflare.com/ajax/libs/angular.js/1.4.2/angular.min.js">&lt;/script>'
	}
	...
	if ($('#prototypejscdnjs').isChecked()) {
		cdn = cdn + '&lt;!-- AngularJS from jsDelivr --><br>&lt;script src="https://cdn.cloudflare.com/ajax/libs/prototype/1.7.2/prototype.min.js">&lt;/script>'
	}	
